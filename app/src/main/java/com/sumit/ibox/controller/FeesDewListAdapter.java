...
public class FeesDewListAdapter extends RecyclerView.Adapter<FeesDewListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
       ...
       // holder.senderThumb.setAnimation(AnimationUtils.loadAnimation(chatContext, R.anim.fade_transition_animation));
        holder.container.setAnimation(AnimationUtils.loadAnimation(studentContext, R.anim.fade_transition_animation));
        ...
        holder.checkBox.setChecked(feeStructure.isSelected());
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(holder.checkBox.isChecked()){
                    touchEvents.onChecked(position);
                }else {
                    touchEvents.onUnchecked(position);
                }
//                FeeStructure feeStructure = feeStructureArray.get(position);
