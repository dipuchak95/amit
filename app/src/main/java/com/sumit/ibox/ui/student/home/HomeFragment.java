...
public class HomeFragment extends Fragment {
    ...
    private LinearLayout options_one_layout_student, options_two_layout_student, options_three_layout_student;
    ...
    private void init(View root) {
        ...
        options_one_layout_student = root.findViewById(R.id.options_one_layout_student);
        options_two_layout_student = root.findViewById(R.id.options_two_layout_student);
        options_three_layout_student = root.findViewById(R.id.options_three_layout_student);
        options_text = root.findViewById(R.id.options_text);
    }

    private void rootLayoutAnimationSetup(){
        ...
        // setup Animation :
        options_text.setAnimation(animeRightToleft);
        options_one_layout_student.setAnimation(animeLeftToRight);
        options_two_layout_student.setAnimation(animeRightToleft);
        options_three_layout_student.setAnimation(animeLeftToRight);
    }
